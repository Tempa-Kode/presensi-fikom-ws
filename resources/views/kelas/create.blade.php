                                ...
                                <div class="col-sm-10">
                                    <select class="js-example-basic-single form-control" name="prodi_id">
                                        ...
                                        @foreach ($prodi as $item)
                                            <option value="{{ $item->id }}" {{ $item->id == old("prodi_id") ? "selected" : "" }}>{{ $item->nama_prodi }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <select class="js-example-basic-single form-control" name="matkul_id">
                                        ...
                                        @foreach ($matkul as $item)
                                            <option value="{{ $item->id }}" {{ $item->id == old("matkul_id") ? "selected" : "" }}>{{ $item->nama_matkul }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <select class="js-example-basic-single form-control" name="dosen_id">
                                        ...
                                        @foreach ($dosen as $item)
                                            <option value="{{ $item->id }}" {{ $item->id == old("dosen_id") ? "selected" : "" }}>{{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
