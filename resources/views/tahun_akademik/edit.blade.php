    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                @endif
                <div class="card">
                    <form action="{{ route("data.tahun_akademik.update", $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        <div class="card-header">
                            <h3 class="card-title">Edit Data Tahun Akademik {{ $data->nama_tahun }}</h3>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_tahun" name="nama_tahun"
                                        value="{{ old("nama_tahun", $data->nama_tahun) }}">
                                </div>
                            </div>
