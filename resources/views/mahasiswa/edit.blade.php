    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                @endif
                <form action="{{ route('data.mahasiswa.update', $data->id) }}" method="post" class="card" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    ...
                    <div class="card-body">
                        ...
                        @if ($data->foto)
                            <div class="row mb-3">
                                <img src="{{ asset($data->foto) }}" alt="Foto mahasiswa" class="img-thumbnail" style="max-width: 200px;">
                            </div>
                        @endif
