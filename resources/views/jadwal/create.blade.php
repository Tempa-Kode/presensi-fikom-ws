                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control js-example-basic-single" id="jam_id" name="jam_id">
                                        ...
                                        @foreach ($jam as $j)
                                            <option value="{{ $j->id }}" {{ old("jam_id") == $j->id ? "selected" : "" }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" id="tipe_pertemuan" name="tipe_pertemuan">
                                        ...
                                        <option value="teori" {{ old("tipe_pertemuan") == "teori" ? "selected" : "" }}>Teori</option>
                                        <option value="praktek" {{ old("tipe_pertemuan") == "praktek" ? "selected" : "" }}>Praktek</option>
                                    </select>
                                </div>
                            </div>
